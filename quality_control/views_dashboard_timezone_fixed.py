"""
View para o dashboard com fuso horário correto do Brasil
"""
...
@csrf_exempt
@login_required
def spot_dashboard_by_line_view_timezone_fixed(request):
    """
    Dashboard de amostras pontuais - FUSO HORÁRIO CORRETO
    Usa fuso horário do Brasil para detectar turno correto
    """
    print("🔍 DEBUG: Iniciando dashboard com fuso horário correto")
    ...
    print(f"🔍 DEBUG: Turno exibido: {current_shift.name}")
