"""
View de debug para o dashboard - busca TODOS os dados sem filtros
"""
...
@csrf_exempt
@login_required
def spot_dashboard_by_line_view_debug(request):
    """
    Dashboard de amostras pontuais - VERSÃO DEBUG
    Busca TODOS os dados sem filtros para identificar o problema
    """
    print("🔍 DEBUG: Iniciando dashboard debug")
