"""
Views de teste para o sistema de análise pontual
"""
...
@login_required
def spot_analysis_test_create(request):
    """Criar nova análise pontual - versão de teste"""
    ...
    return render(request, 'quality_control/spot_analysis_test.html', context)
