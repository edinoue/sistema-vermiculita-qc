...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-sua-chave-secreta-123456789')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True  # Deixar True para facilitar debug
...
# CORS settings - MUITO PERMISSIVO
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Muito permissivo para teste
    ],
